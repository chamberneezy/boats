    ...
    <div className="relative w-full" ref={containerRef}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-2xl border-[1.5px] border-hairline bg-mist px-4 py-3 pl-10 text-[12px] font-medium text-slate-900 outline-none transition focus:border-accent focus:bg-white focus:ring-2 focus:ring-accent/20 sm:py-3.5"
        />
      </div>
